...
r_strength = [34.0, 36.0, 38.0, 42.0]  # 44.0
a_strength = [16.0, 18.0, 22.0, 24.0]  # 26.0
...
for c_value, ax in zip(constants, axes.flat):  # in range(len(constants)):
    ...
    ax.set_xticklabels(['', '$R=34$', '', '$R=36$', '', '$R=38$', '', '$R=42$'])  # 34.0, 36.0, 38.0, 42.0]
    ax.set_yticklabels(['', '$A=24$', '', '$A=22$', '', '$A=18$', '', '$A=16$'])  # 16.0, 18.0, 22.0, 24.0
    ...
    cbar.set_label('$\Delta_{Flow\/rate}$', size=14)    
fig.tight_layout()
plt.show() 
