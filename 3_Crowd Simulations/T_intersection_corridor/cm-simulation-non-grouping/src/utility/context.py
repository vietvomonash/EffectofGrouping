...
class ContextGenerator(object):
    ...
    def __init__(self, parameters, placement_num):
        ...
        for start_area_index in range(len(self.parameters['start_areas'])):
            
            grid = self._generate_placement_area(self.parameters, self.parameters['start_areas'][start_area_index], grid_cell_size)
