...
class Scenario:
    ...
    def run_aggregate(self,
        ...
        while current_simulation_run < 1:#len(placement_generators)/total_group_num :
            ...
            if self.spawn_new_pedestrians==False:
                ...
                radii_generator1 = radii_generators[index:index + total_group_num]
                placement_generator1 = placement_generators[index:index + total_group_num]
                population_generator._generate_population(radii_generator1,placement_generator1)                    
                group_pedestrians1 = population_generator._initialize_generated_group_pedestrians_friend_zone(additional_ped_info)
                       
                bio_index = int(len(radii_generators)/2) + index
                radii_generator2 = radii_generators[bio_index:bio_index + total_group_num]
                placement_generator2 = placement_generators[bio_index:bio_index + total_group_num]
                population_generator._generate_population(radii_generator2,placement_generator2,len(group_pedestrians1))  
                group_pedestrians2 = population_generator._initialize_generated_group_pedestrians_friend_zone(additional_ped_info)
                ...
                group_pedestrians1 = population_generator._initialize_generated_group_pedestrians_population(ids_each_group)
                ...
                group_pedestrians2 = population_generator._initialize_generated_group_pedestrians_population(ids_each_group2)
    ...
    def _spawn_pedestrians(self,context_index): #re-change by spawn by file
        ...
        if self.spawn_new_pedestrians==True:
            ...
            population_generator1  =  PopulationGenerator(self.parameters,
            ...
            population_generator2  =  PopulationGenerator(self.parameters,
                                                        self.parameters['in_group_a_strength'],self.parameters['in_group_a_range'],
                                                        self.parameters['in_group_r_strength'],self.parameters['in_group_r_range'],
                                                        self.parameters['out_group_a_strength'],self.parameters['out_group_a_range'],
                                                        self.parameters['out_group_r_strength'],self.parameters['out_group_r_range'],
            ...
            pedestrian_current_id1 = population_generator1._generate_population(radii_generator1,placement_generator1,population_number)          
            current_ped_generator1 = [temp_id for temp_id in range(population_number,pedestrian_current_id1)]
        
            pedestrian_current_id2 = population_generator2._generate_population(radii_generator2,placement_generator2,pedestrian_current_id1)
            current_ped_generator2 = [temp_id for temp_id in range(pedestrian_current_id1,pedestrian_current_id2)]            
            
            
            additional_pedestrians1, additional_id_existed_ped1 = population_generator1._get_generated_group_pedestrians_population(ids_each_group+current_ped_generator2) 
                   
            additional_pedestrians2, additional_id_existed_ped2 = population_generator2._get_generated_group_pedestrians_population(ids_each_group+current_ped_generator1) 
            ...
            disp_level = self.parameters['out_group_r_strength']/self.parameters['in_group_r_strength']   
            frame_generator1 = frame_context(str(self.frames),additional_pedestrians1,additional_id_existed_ped1)
            ...
            json_obj = json.dumps(frame_generator1, cls=FrameContextLog_Encoder)
            log_file.write(json_obj)
            log_file.close()
   
            frame_generator2 = frame_context(str(self.frames),additional_pedestrians2,additional_id_existed_ped2)
            frame_filename = "%s" % (str(disp_level) + "_" + str(context_index) + "_" + str(int(self.frames)))
            log_file = open( "%s_2.json" % os.path.join(self.adaptive_context_dir, frame_filename), "w")
            json_obj = json.dumps(frame_generator2, cls=FrameContextLog_Encoder)
            log_file.write(json_obj)
            log_file.close()     
