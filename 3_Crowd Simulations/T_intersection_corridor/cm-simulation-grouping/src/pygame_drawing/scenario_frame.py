...
class Scenario_Frame:
    ...
    def __init__(self, parameters = {}):
        ...
        self.turning_area       = Path([(20.0-self.shift_x,41.0+self.shift_y), (50.0-self.shift_x, 41.0+self.shift_y), (50.0-self.shift_x,9.0+self.shift_y), (20.0-self.shift_x, 9.0+self.shift_y)])                                                     
    ...
    def _draw(self):
        ...
        turning_draw = (20.0-self.shift_x,9.0+self.shift_y,50.0-self.shift_x, 41.0+self.shift_y)
